...
#b.
# Harris corners would be better if we would be looking only for detecting corners. Harris corner-
# is also fast and relatively uncomplex. Surf provides feature descriptors and when Harris
# provides only the location, in these cases SURF would prevail.