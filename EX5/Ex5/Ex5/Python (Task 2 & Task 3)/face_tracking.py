...
# - The biggest issue is the program can not track successfully if the face is moving.
# - The possible solution could be that we add the number of feature points required for the tracking.
# - This should lead to a situation where the detection is not reset as often as now.
#